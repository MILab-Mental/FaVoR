...
"""Factories and checkpoint utilities for Video JEPA pretraining."""
...
from . import predictor as vit_pred
from . import vision_transformer as video_vit
...
def load_checkpoint(
    r_path, encoder, predictor, target_encoder, opt, scaler, is_anneal=False, reset_epoch=False
):
